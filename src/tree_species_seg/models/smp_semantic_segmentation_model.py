...
class ForestSemanticSegmentationModule(pl.LightningModule):
    ...
    def _create_loss_function(self, class_distribution: Optional[Dict[int, int]] = None):
        ...
        if self._loss_config["label_smoothing"] is not None and loss_type in ["cross_entropy", "cross_entropy_lovasz"]:
        ...
        if (
            ...
            and loss_type in ["cross_entropy", "cross_entropy_lovasz"]
        ):
